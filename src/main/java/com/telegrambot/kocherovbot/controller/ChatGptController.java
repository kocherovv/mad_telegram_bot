...
import com.telegrambot.kocherovbot.models.dto.GptRequest;
import com.telegrambot.kocherovbot.models.dto.GptResponse;
...
public class ChatGptController {
    ...
    @GetMapping("/chat")
    public String getGptAnswer(@RequestParam String prompt) {
